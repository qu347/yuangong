  ...
  Future<void> submit() async {
    ...
    try {
      await ref
          ...
          .confirmReset(token.text, password.text);
      token.clear();
      password.clear();
      confirm.clear();
            ...
            child: Column(
              children: [
                TextFormField(
                  ...
                  validator: (value) =>
                      value == null || value.trim().isEmpty ? '请输入重置码' : null,
                ),
                const SizedBox(height: 12),
                SecurePasswordField(controller: password, label: '新密码'),
                const SizedBox(height: 12),
                SecurePasswordField(
                  controller: confirm,
                  label: '确认新密码',
                ...
                FilledButton(
                  ...
                  child: Text(submitting ? '正在提交' : '更新密码'),
                ),
              ],
            ),
          ),
